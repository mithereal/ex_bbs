defmodule Api.Bbs.SchemaFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Api.Bbs.Schema` context.
  """
  ...
  def category_fixture(attrs \\ %{}) do
    {:ok, category} =
      ...
      |> Api.Bbs.Schema.create_category()
  ...
  def auth_access_fixture(attrs \\ %{}) do
    {:ok, auth_access} =
      ...
      |> Api.Bbs.Schema.create_auth_access()
  ...
  def disallow_fixture(attrs \\ %{}) do
    {:ok, disallow} =
      ...
      |> Api.Bbs.Schema.create_disallow()
  ...
  def forum_prune_fixture(attrs \\ %{}) do
    {:ok, forum_prune} =
      ...
      |> Api.Bbs.Schema.create_forum_prune()
  ...
  def post_text_fixture(attrs \\ %{}) do
    {:ok, post_text} =
      ...
      |> Api.Bbs.Schema.create_post_text()
  ...
  def priv_msg_fixture(attrs \\ %{}) do
    {:ok, priv_msg} =
      ...
      |> Api.Bbs.Schema.create_priv_msg()
  ...
  def priv_msg_text_fixture(attrs \\ %{}) do
    {:ok, priv_msg_text} =
      ...
      |> Api.Bbs.Schema.create_priv_msg_text()
  ...
  def search_result_fixture(attrs \\ %{}) do
    {:ok, search_result} =
      ...
      |> Api.Bbs.Schema.create_search_result()
  ...
  def search_wordlist_fixture(attrs \\ %{}) do
    {:ok, search_wordlist} =
      ...
      |> Api.Bbs.Schema.create_search_wordlist()
  ...
  def search_wordmatch_fixture(attrs \\ %{}) do
    {:ok, search_wordmatch} =
      ...
      |> Api.Bbs.Schema.create_search_wordmatch()
  ...
  def session_keys_fixture(attrs \\ %{}) do
    {:ok, session_keys} =
      ...
      |> Api.Bbs.Schema.create_session_keys()
  ...
  def theme_name_fixture(attrs \\ %{}) do
    {:ok, theme_name} =
      ...
      |> Api.Bbs.Schema.create_theme_name()
  ...
  def topic_watch_fixture(attrs \\ %{}) do
    {:ok, topic_watch} =
      ...
      |> Api.Bbs.Schema.create_topic_watch()
  ...
  def user_group_fixture(attrs \\ %{}) do
    {:ok, user_group} =
      ...
      |> Api.Bbs.Schema.create_user_group()
  ...
  def vote_desc_fixture(attrs \\ %{}) do
    {:ok, vote_desc} =
      ...
      |> Api.Bbs.Schema.create_vote_desc()
  ...
  def vote_result_fixture(attrs \\ %{}) do
    {:ok, vote_result} =
      ...
      |> Api.Bbs.Schema.create_vote_result()
  ...
  def vote_voter_fixture(attrs \\ %{}) do
    {:ok, vote_voter} =
      ...
      |> Api.Bbs.Schema.create_vote_voter()
